...
With Rails 2.X you have to use:

  script/plugin install git://github.com/cingel/mark_it_up.git

Copy all assets from [Rails.root]/vendor/plugins/mark_it_up/lib/public/mark_it_up to [Rails.root]/public/mark_it_up
...
{gwarf Baptiste Grenier}http://github.com/gwarf
