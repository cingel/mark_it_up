...
This will all copy all assets from [Rails.root]/vendor/plugins/mark_it_up/lib/public/mark_it_up to [Rails.root]/public/mark_it_up

You will also need jQuery[http://jquery.com] (You can use CDN hosted jQuery). 
<%= javascript_include_tag "http://code.jquery.com/jquery-1.4.3.min.js" %>
