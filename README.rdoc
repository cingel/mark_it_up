...
*THIS IS A RAILS 2.x PLUGIN, IF YOU ARE USING RAILS 3.x PLEASE USE THE GEM INSTEAD (gem install mark_it_up) OR SWITCH TO MASTER BRANCH*
...
- Find a way to provide function assignment to replaceWith ( replaceWith: function() { return "something from function" } )
